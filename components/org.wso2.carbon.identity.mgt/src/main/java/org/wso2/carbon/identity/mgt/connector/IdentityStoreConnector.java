...
public interface IdentityStoreConnector {
     ...
     * @param attributeNames UserImpl attribute names.
     ...
     * @throws GroupNotFoundException GroupImpl not found exception.
     * @throws IdentityStoreConnectorException Identity Store Connector Exception.
     */
     ...
     *
     * @param userIdentifier UserImpl identifier.
     ...
     *
     * @param userIdentifier   UserImpl identifier.
     * @param groupIdentifiers GroupImpl identifiers.
     * @throws IdentityStoreConnectorException Identity Store Connector Exception.
     */
     ...
     *
     * @param userIdentifier           UserImpl identifier.
     * @param groupIdentifiersToAdd    GroupImpl identifier list to update.
     * @param groupIdentifiersToRemove GroupImpl identifier list to remove.
     * @throws IdentityStoreConnectorException Identity Store Connector Exception.
     */
     ...
     *
     * @param groupIdentifier GroupImpl identifier.
     * @param attributes      Attribute values to update.
     * @return connector unique id of group.
     * @throws IdentityStoreConnectorException Identity Store Connector Exception.
     */
     ...
     *
     * @param groupIdentifier GroupImpl identifier.
     * @param userIdentifiers UserImpl identifier list.
     * @throws IdentityStoreConnectorException Identity Store Connector Exception.
     */
     ...
     *
     * @param groupIdentifier         GroupImpl identifier.
     * @param userIdentifiersToAdd    UserImpl identifier list to add.
     * @param userIdentifiersToRemove UserImpl identifier list to remove.
     * @throws IdentityStoreConnectorException Identity Store Connector Exception.
     */
