...
import org.wso2.carbon.identity.mgt.impl.internal.config.connector.ConnectorConfigBuilder;
import org.wso2.carbon.identity.mgt.impl.internal.config.domain.DomainConfigBuilder;
import org.wso2.carbon.identity.mgt.impl.internal.config.store.StoreConfigBuilder;
...
import org.wso2.carbon.identity.mgt.impl.user.impl.JDBCUniqueIdResolverFactory;
...
public class IdentityMgtComponent implements RequiredCapabilityListener {
    ...
    public void onAllRequiredCapabilitiesAvailable() {
        ...
        try {
            ...
            RealmService realmService = new RealmServiceImpl(identityStore, authorizationStore);
